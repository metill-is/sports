...
parameters {
  ...
  real alpha_rho;            // Correlation between home and away goals
  real beta_rho;
  real beta2_rho;
  real beta3_rho;
}
...
model {
  ...
  for (n in 1:N) {
    ...
    real logit_rho = alpha_rho + beta_rho * strength_diff + beta2_rho * total_strength + beta3_rho * total_strength * strength_diff;

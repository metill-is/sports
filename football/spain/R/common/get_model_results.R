...
generate_model_results <- function(from_season = 2021, make_plots = TRUE) {
  ...
  plot <- predictions |>
    ...
    labs(
      ...
      colour = NULL,
      title = paste0(
        "Vikuleg fótboltaspá Metils fyrir Serie A"
      ),
      subtitle = str_c(
  ...
  plot_dat |>
    ...
    labs(
      title = "Líkindadreifing yfir stigafjölda liða í Serie A undir lok tímabils",
      subtitle = str_c(
  ...
  plot_dat |>
    ...
    labs(
      x = NULL,
      y = NULL,
      title = "Líkindadreifing yfir lokasæti í Serie A"
    )
  ...
  plot_dat |>
    ...
    labs(
      ...
      y = NULL,
      colour = NULL,
      title = "Styrkur félagsliða í Serie A",
  ...
  results$draws("home_advantage_tot") |>
    ...
    labs(
      ...
      y = NULL,
      colour = NULL,
      title = "Heimavallaráhrif í Serie A",

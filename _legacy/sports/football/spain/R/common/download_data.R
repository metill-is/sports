...
#' Make a results URL for Spanish football league
#'
...
make_results_url <- function(league_name, year_start, year_end) {
  ...
  glue(
    "https://www.livesport.com/en/soccer/spain/{league_name}-{year_start}-{year_end}/results/"
  )
}

#' Make a schedule URL for Spanish football league
#'
#' @param league_name The name of the league
...
make_schedule_url <- function(league_name) {
  ...
  glue(
    "https://www.livesport.com/en/soccer/spain/{league_name}/fixtures/"
  )
}

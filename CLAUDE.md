...
| **4: Decide + Publish** | Joint Kelly + portfolio + calibration → recommendations Parquet; football iceland 11/12-JSON publisher (per cell in `publish_divisions`: male BD/LD1/LD2/LD3/CUP, female BD/LD1/LD2/CUP) + basketball/handball 8-JSON publishers (seasonally paused) | ✅ Complete |
